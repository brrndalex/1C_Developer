...
# Данные заказчика:
* 1.Модели яхт: стандартные, эконом класса, класса Люкс.
* 2.Варианты окраски яхты: 
  - Стандартные цвета: белый, синий, голубой, бирюзовый. 
  - Другие цвета – возможны за дополнительную плату.
* 3.Материал изготовления яхт (все яхты и лодки изготавливаются только из дерева): дуб, береза, ель, сосна или лиственница.
* 4.Каталог продукции.     
