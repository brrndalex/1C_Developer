...
Перед окончательным подписанием договора необходимо обязательно проверить личность клиента. Для этого необходимо предусмотреть хранение в системе данных об общегражданском или заграничном паспорте клиента. Должна храниться следующая информация:
