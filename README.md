...
|   № |    Бизнес - задача  |   Дополнительные пояснения |  Описание | Инструменты |
|:----|:---------------------|:---------|:----------------------|:-----------|
...
|   2.  |    [Разработать систему, предназначенную для сотрудников компании, которая занимается организацией туристических поездок в различные страны.](https://github.com/brrndalex/1C_Developer/tree/main/Business%20task_2)                          |   Агенты и мнеджеры компании собирают пожелания клиентов по путешествиям в виде предварительных соглашений. Когда клиент подтверждает свою готовность отправиться в тур, с ним оформляется договор. Оформление поездки состоит из следующих этапов: 1. Предварительное соглашение. 2. Офрмление договора. Все этапы обязательны и должны выполняться строго в заданной последовательности.      |  Python (библиотеки: confluent_kafka(Producer), json, csv), Apache Spark (PySpark), Docker compose, Hadoop (HDFS), Apache Kafka. Jupyter Notebook.                     |  
